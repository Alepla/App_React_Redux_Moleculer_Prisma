...
export const PROFILE_LIST_FRIENDS = 'PROFILE_LIST_FRIENDS';
export const USER_PAGE_LOADED = 'USER_PAGE_LOADED';
export const USER_PAGE_UNLOADED = 'USER_PAGE_UNLOADED';
export const SET_PAGE_LIST_FRIENDS = 'SET_PAGE_LIST_FRIENDS';
...
export const CHECKOUT_NOTIFICATIONS = 'CHECKOUT_NOTIFICATIONS';
export const NOTIFICATIONS_PAGE_LOADED = 'NOTIFICATIONS_PAGE_LOADED';
export const ON_REFUSE_USER = 'ON_REFUSE_USER';
